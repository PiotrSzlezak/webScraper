...
public class RdbTableDTO {

    private final static Logger log = LoggerFactory.getLogger(RdbTableDTO.class);
    ...
    public RdbTable toRdb() {
        RdbTable rdbTable = new RdbTable();
        rdbTable.setDataDostawy(dataDostawy);
        rdbTable.setPoczatekPomiaru(poczatekPomiaru);
        rdbTable.setKoniecPomiaru(koniecPomiaru);
        rdbTable.setKursMinPlnMWh(kursMinPlnMWh);
        rdbTable.setKursMinEurMWh(kursMinEurMWh);
        rdbTable.setKursMaksPlnMWh(kursMaksPlnMWh);
        rdbTable.setKursMaksEurMWh(kursMaksEurMWh);
        rdbTable.setOstatniKursPlnMWh(ostatniKursPlnMWh);
        rdbTable.setOstatniKursEurMWh(ostatniKursEurMWh);
        rdbTable.setLacznyWolumenMWh(lacznyWolumenMWh);
        return rdbTable;
    }
